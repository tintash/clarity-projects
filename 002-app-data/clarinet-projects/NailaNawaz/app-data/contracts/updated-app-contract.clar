...
(define-data-var temp-sum uint u0)
...
(define-public (get-sum-updated (data-contract <data-trait>) (num1 uint) (num2 uint) (num3 uint))
       (begin 
              (var-set temp-sum (try! (contract-call? data-contract get-sum num1 num2)))
              (ok (try! (contract-call? data-contract get-sum (var-get temp-sum) num3)))
       )
)